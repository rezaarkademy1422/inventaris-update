<img src="img/tslpt.png" style="width: 130px; height: 100px" align="left">

<h1 style="padding: 10px; margin: 10px;">CARI DATA Transaksi Laptop</h1>
<br>
<br>
...
<a href="transaksiLPT.php" style="background-color: red; padding: 10px; float: right; margin: 10px; box-shadow: 1px 1px 1px 1px black ;">Kembali</a>
...
?>
		...
		<tr style="border: 1px solid; border-radius: 31px; box-shadow: 2px 2px;">
			...
			<td ><button type="submit" name="btn-delTSLPT" onclick="return confirm('Apakah Anda Yakin Akan Menghapus Data Tersebut ?')" style="background-color: red ">Hapus</button>
				<button style="background-color: green;"><a name="btn-edtTSLPT" href="editTSLPT.php?kodebarang=<?php echo $data['kodebarang']?>"  >Edit/Lihat selengkapnya</a></button>
			</td>
		</tr>
