...
require_once 'Koneksi.php';
 $sql = mysqli_query($dbc, "SELECT * FROM tbtransaksihp where kodebarang = '$_GET[kodebarang]' ");
...
<div style="">
	<img src="img/tshp.png" style="width: 100px; height: 100px; padding: 10px;" align="left">
	<h1>SILAHKAN EDIT DATA</h1>
	<a href="cariTSHP.php" style="background-color: red; padding: 10px; float: right; margin: 10px; box-shadow: 1px 1px 1px 1px black ;">Kembali</a>
</div>
...
<form method="post" enctype= "multipart/form-data" >
	...
	<input type="text" name="sn" value="<?php echo $data['sn'];?>" >
		...
		<div class="form">
		<label>IMEI 1</label>
	<input type="number" name="imei1" value="<?php echo $data['imei1'];?>" >
	</div>

		<div class="form">
		<label>IMEI 2</label>
	<input type="number" name="imei2" value="<?php echo $data['imei2'];?>" >
	</div>
...
<div class="form">
	...
	<div class="form">
<button type="submit" name="btn-edtTSHP" style="background-color: green; height: 50px; width: 100%; color: white; font-size: 20px; " onclick="berhasil()">Simpan Perubahan</button>
</div>
