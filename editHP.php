...
<form method="post" enctype= "multipart/form-data" >
	...
	<div class="form">
		<label>IMEI 1</label>
	<input type="text" name="imei1" value="<?php echo $data['imei1'];?>" >
	</div>
	
		<div class="form">
		<label>IMEI 2</label>
	<input type="text" name="imei2" value="<?php echo $data['imei2'];?>" >
	</div>
...
<button type="submit" name="btn-edtHP" style="background-color: green; height: 50px; width: 100%; color: white; font-size: 20px; " onclick="berhasil()">Simpan Perubahan</button>
</div>
