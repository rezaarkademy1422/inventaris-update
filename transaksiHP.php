...
<html>
<head>
 <title>Data Transaksi Handphone</title>
...
<div style="">
	...
	<h1>INPUT DATA Transaksi Handphone</h1>
</div>
	<div >
	<a href="Home.php" style="background-color: red;" >Kembali</a>
	<a href="cariTSHP.php"  >Cari Data Transaksi</a>
...
<form method="post" enctype= "multipart/form-data" action="functionall.php" >
	...
	<div class="form">
		<label>IMEI 1</label>
	<input type="number" name="imei1" placeholder="...">
	</div>
	
		<div class="form">
		<label>IMEI 2</label>
	<input type="number" name="imei2" placeholder="...">
	</div>
...
<button type="submit" name="btn-tmbhTSHP" style="background-color: green; height: 50px; width: 100%; color: white; font-size: 20px; " onclick="berhasil()">Tambah</button>
</div>
