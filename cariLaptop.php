<img src="img/laptop3.png" style="width: 130px; height: 100px" align="left">

<h1 style="padding: 10px; margin: 10px;">CARI DATA LAPTOP</h1>
<br><br>
...
<a href="Laptop.php" style="background-color: red; padding: 10px; float: right; margin: 10px; box-shadow: 1px 1px 1px 1px black ;">Kembali</a>
...
?>
		...
		<tr style="border: 1px solid; border-radius: 31px; box-shadow: 2px 2px;">
			...
			<td ><button type="submit" name="btn-delLPT" onclick="return confirm('Apakah Anda Yakin Akan Menghapus Data Tersebut ?')" style="background-color: red ">Hapus</button>
				<button style="background-color: green;"><a name="btn-edtLPT" href="editLaptop.php?kodebarang=<?php echo $data['kodebarang']?>"  >Edit/Lihat</a></button>
			</td>
		</tr>
