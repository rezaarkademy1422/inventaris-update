...
<div style="">
	...
	<h1>INPUT DATA HANDPHONE</h1>
</div>
	<div >
	<a href="Home.php" style="background-color: red;">Kembali</a>
	<a href="cariHP.php"  >Cari Data Handphone</a>
...
<button type="submit" name="btn-tmbhHP" style="background-color: green; height: 50px; width: 100%; color: white; font-size: 20px; " onclick="berhasil()">Tambah</button>
</div>
